...
if (!text.includes("import { maybeKnowledgeFirstRecommendation } from '../ai/knowledgeFirstRecommender';")) {
  text = text.replace(
    "import { fetchMetadata } from '../services/metadata';",
    "import { fetchMetadata } from '../services/metadata'; import { maybeKnowledgeFirstRecommendation } from '../ai/knowledgeFirstRecommender';"
  );
}
...
console.log('JoeAI intent parser now routes recommendations through Knowledge/Genome/Intent before Anime DNA fallback.');
